...
if [[ ! -f $HOME/.config/nvim ]]; then
  ln -sfn $CURRENT_PATH $HOME/.config/nvim
fi
...
echo "[*] Downloading patch font into $HOME/Library/Fonts ..."
curl -fLo $HOME/Library/Fonts/Iosevka\ Term\ Nerd\ Font\ Complete.ttf --create-dirs https://github.com/ryanoasis/nerd-fonts/raw/master/patched-fonts/Iosevka/Regular/complete/Iosevka%20Term%20Nerd%20Font%20Complete.ttf
